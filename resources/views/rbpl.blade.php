...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top">
        <div class="container-fluid">
            ...
            <img src="Infacare logo.png" alt="Avatar Logo" style="width:40px;" class="rounded-pill">
        ...
        <div class="card mb-3" style="max-width: 450px;">
            <div class="row g-0">
                ...
                <div class="col-md-4 py-5" style="max-width: 200px;">
                    <img src="stunt.png" class="img-fluid rounded-start" alt=" ">
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 450px;">
            <div class="row g-0">
                ...
                <div class="col-md-4 py-5" style="max-width: 200px;">
                    <img src="nutrisi.png" class="img-fluid rounded-start" alt=" ">
                </div>
            </div>
        </div>
        <div class="card mb-3" style="max-width: 450px;">
